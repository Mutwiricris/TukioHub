    ...
    public function run(): void
    {
        ...
        $organizers = [
            [
                ...
                'categories' => json_encode(['Music', 'Festival', 'Entertainment']),
            ...
            [
                ...
                'categories' => json_encode(['Technology', 'Innovation', 'Startups']),
                'primary_location' => 'Nairobi',
                'serves_nationwide' => true
            ],
            [
                ...
                'is_verified' => true,
                'is_primary' => true,
                'business_type' => 'Arts & Culture',
                'categories' => json_encode(['Art', 'Culture', 'Theater']),
                'primary_location' => 'Nairobi',
            ...
            [
                ...
                'categories' => json_encode(['Sports', 'Marathon', 'Athletics']),
                'primary_location' => 'Nairobi',
                'serves_nationwide' => true
            ],
            [
                ...
                'categories' => json_encode(['Food', 'Festival', 'Culinary']),
                'primary_location' => 'Nairobi',
                'serves_nationwide' => true
            ],
            [
                ...
                'is_primary' => false,
                'business_type' => 'Entertainment',
                'categories' => json_encode(['Comedy', 'Entertainment', 'Shows']),
                'primary_location' => 'Nairobi',
                'serves_nationwide' => false
            ],
            [
                ...
                'categories' => json_encode(['Fashion', 'Design', 'Runway']),
                'primary_location' => 'Nairobi',
                'serves_nationwide' => true
            ],
            [
                ...
                'is_primary' => true,
                'business_type' => 'Entertainment',
                'categories' => json_encode(['Film', 'Cinema', 'Arts']),
                'primary_location' => 'Nairobi',
                'serves_nationwide' => true
            ],
            [
                ...
                'categories' => json_encode(['Business', 'Networking', 'Conference']),
                'primary_location' => 'Nairobi',
                'serves_nationwide' => true
            ],
            [
                ...
                'categories' => json_encode(['Wellness', 'Health', 'Mindfulness']),
                'primary_location' => 'Nairobi',
                'serves_nationwide' => false
            ],
            [
                ...
                'categories' => json_encode(['Books', 'Literature', 'Education']),
                'primary_location' => 'Nairobi',
                'serves_nationwide' => true
            ],
            [
                ...
                'categories' => json_encode(['Gaming', 'Esports', 'Technology']),
                'primary_location' => 'Nairobi',
                'serves_nationwide' => false
            ]
        ];
