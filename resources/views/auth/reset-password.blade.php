  ...
  <div class="relative flex items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <div class="text-center">
        ...
        <h2 class="text-3xl font-bold bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent">Create new password</h2>
        <p class="mt-3 text-gray-400">Enter your new password to complete the reset</p>
      </div>
